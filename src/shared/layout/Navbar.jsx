    ...
    >
      ...
      <div className="px-4 py-3">
        ...
        <div className="mt-3 pt-3 border-t border-gray-100">
          <Link to="/seller" className="block w-full text-center text-xs font-bold text-[#03ac0e] hover:underline">
            Kelola Toko →
          </Link>
        </div>
      </div>
    ...
    <header className="sticky top-0 z-50">
      ...
      <div className="relative bg-white">
        <div className="max-w-[1200px] mx-auto px-4 flex items-center gap-4 h-16">
          ...
          <Link to="/" className="text-[22px] font-bold text-[#006e04] flex-shrink-0 leading-none">
            tokopedia
          </Link>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <Link to="/cart" className="p-2 hover:bg-gray-100 text-gray-600" style={{ borderRadius: 5 }}>
