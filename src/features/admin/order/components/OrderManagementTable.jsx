...
export const OrderManagementTable = memo(function OrderManagementTable({ rows, portal, pendingId, onStatusChange, onPrint, columns = ORDER_TABLE_COLUMNS, visibleSet, selectionEnabled = false, selectedIds = new Set(), allSelected = false, onToggleRow, onToggleAll }) {
