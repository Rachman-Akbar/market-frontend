...
export const ProductStockFields = memo(function ProductStockFields({ mode, sku, price, stock, poStock, maxOrderQty, variants, errors, onSimpleChange, onVariantsChange }) {
