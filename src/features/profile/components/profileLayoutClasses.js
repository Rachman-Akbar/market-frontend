export const profileLayout = {
  ...
  contentEyebrow: "text-xs font-semibold uppercase tracking-[0.18em] text-[#ee4d2d]",
  contentDesc: "max-w-2xl text-sm leading-6 text-slate-500",
  divider: "border-[#e5e7eb]",
  searchBox: "flex h-11 items-center rounded-lg bg-white px-3 text-slate-400 ring-1 ring-[#e5e7eb] focus-within:ring-[#ee4d2d]",
  primaryButton: "inline-flex h-10 items-center justify-center gap-2 rounded-full bg-[#ee4d2d] px-5 text-sm font-semibold text-white transition hover:bg-[#d73211]",
  secondaryButton: "inline-flex h-10 items-center justify-center gap-2 rounded-full border border-[#e5e7eb] px-5 text-sm font-semibold text-slate-600 transition hover:border-[#ee4d2d] hover:text-[#ee4d2d]",
};
