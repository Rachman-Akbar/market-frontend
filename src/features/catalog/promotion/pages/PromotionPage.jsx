    ...
    <main className="mx-auto max-w-[1200px] px-4 py-8">
      <div className="mb-6 flex items-end justify-between gap-4">
        <div>
          ...
          <h1 className="mt-2 text-2xl font-extrabold text-[#1b1c1c]">
            Promo, voucher, dan campaign terbaru
          </h1>
          <p className="mt-1 text-sm text-[#3e4a39]">
            Voucher aktif yang tersedia dari backend order.
          </p>
        </div>
      </div>

      {promotionsQuery.isLoading ? (
        <p className="py-12 text-sm text-gray-500">Memuat promo...</p>
      ) : null}
