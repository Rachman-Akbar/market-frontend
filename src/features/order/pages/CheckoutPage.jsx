...
import { useCart } from "@/features/order/context/CartContext";
import { mockAddresses, shippingOptions } from "@/shared/data/mockData";
...
export default function CheckoutPage() {
  ...
  const [address, setAddress] = useState(mockAddresses[0]);
  ...
  const handleConfirmOrder = () => {
    clearCart();
    navigate(`/orders/${orderId}?total=${total}&payment=${payment}&shipping=${shipping.courier} ${shipping.service}`);
  };
