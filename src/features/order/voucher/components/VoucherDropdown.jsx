        ...
        <div className="grid grid-cols-3 gap-4">
          {visibleVouchers.map((voucher) => (
            <div
              ...
              className="min-h-[118px] overflow-hidden rounded-xl border border-gray-200 bg-white transition-[border-color,transform] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-0.5 hover:border-[#10B981]"
            >
              <div
                className={
                  voucher.imageUrl
                    ? "grid min-h-[118px] grid-cols-[92px_minmax(0,1fr)]"
                    : "min-h-[118px] p-4"
                }
              >
                {voucher.imageUrl ? (
